...
void CBottomBarWnd::CreateVolume()
{
	...
	m_pclVolumeWnd->Create(m_hWnd, "VolumeWnd", WS_POPUP, NULL);
}
...
void CBottomBarWnd::CreateVolumeTip()
{
	...
	m_pclVolumeTipWnd->Create(m_hWnd, "VolumeTipWnd", WS_POPUP, NULL);
}
...
void CBottomBarWnd::CreateVolumeBackground()
{
	...
	m_pclVolumeBackgroundWnd->Create(m_hWnd, "VolumeBackgroundWnd", WS_POPUP, NULL);
}
...
void CBottomBarWnd::CreateScreenRatio()
{
	...
	m_pclScreenRatioWnd->Create(m_hWnd, "ScreenRatioWnd", WS_POPUP, NULL);
}
